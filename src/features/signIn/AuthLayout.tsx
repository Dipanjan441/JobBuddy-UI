    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4">
            <div className="w-full max-w-[800px] h-[85vh] lg:h-[90vh] min-h-[450px] bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex">
                ...
                <div className="hidden md:flex md:w-1/2 bg-linear-to-br from-brand-deep via-brand-blue to-brand-accent p-6 flex-col relative overflow-y-auto overflow-x-hidden no-scrollbar">
                    ...
                    <div className="relative z-10 w-full flex-grow flex flex-col justify-center">
                        <div className="cursor-pointer inline-block mb-6">
                        ...
                        <div className="pt-6">
                            <p className="text-white text-[10px] font-black uppercase tracking-[0.2em] mb-2">Trusted by users at</p>
                ...
                <div className="w-full md:w-1/2 flex flex-col p-6 md:p-8 relative overflow-y-auto no-scrollbar">
                    <div className="md:hidden mb-6 flex justify-between items-center">
                        ...
                        <button
                            ...
                            onClick={() => navigate(HOME_ROUTE.path)}
                        >
                            <X size={24} />
                        </button>
                    </div>
