...
import { FORGOT_PASSWORD_ROUTE, SIGNUP_ROUTE } from '../routes/routes';
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                    <div className="flex justify-between items-center">
                        ...
                        <button
                            type="button"
                            className="text-xs cursor-pointer font-bold text-brand-blue hover:text-brand-deep transition-colors mb-2 mr-1"
                            onClick={() => navigate(FORGOT_PASSWORD_ROUTE.path)}
                        >
                            Forgot Password?
                        </button>
                    </div>
                ...
                <button type="button" className="w-full cursor-pointer py-4 border border-slate-200 rounded-2xl flex items-center justify-center gap-3 font-bold text-slate-600 hover:bg-slate-50 transition-all active:scale-[0.98]">
                ...
                <p className="text-center text-slate-500 font-medium text-sm mt-8">
                    ...
                    <button
                        type="button"
                        onClick={() => navigate(SIGNUP_ROUTE.path)}
